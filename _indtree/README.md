...
| `ST_BASE` | hub 决策连续（§9.8） | 🔄 求解中（gap 3%） | | | | 1% 版跑 2 h 停在 3 896 / 3 781（2.95%），日志 `ST_BASE_gap1_partial.log` |
| `ST_WA_cwatm_126_dry_oq` | hub 决策连续 | 🔄 求解中（gap 3%） | | | | 1% 版停在 4 570 / 4 445（2.74%） |
