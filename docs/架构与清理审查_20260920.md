...
> 文中的文件与行号是 2026-09-20 当日的快照。2026-09-26 起 `experiments/`、`optimization/model.py`、
> `optimization/bundle.py`、`reporting/`、`scripts/validate_inputs.py` 已删除，求解入口只剩 `scripts/run_single.py`（`_indtree` 里是同一份副本）；
